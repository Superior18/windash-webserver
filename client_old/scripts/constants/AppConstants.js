define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            HOST: (window.document.location.host === 'www.windash.us' || window.document.location.host === 'www.moneypot.com') ? 'https://gs.windash.us' : window.document.location.host.replace(/:2087$/, ':8443'),
