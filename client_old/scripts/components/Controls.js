define([
    ...
    return React.createClass({
        ...
        _invalidBet: function () {
            ...
            if (self.state.engine.balanceDuffs < 100)
                return 'Not enough μDash to play';
            ...
            if (self.state.engine.balanceDuffs < bet * 100)
                return 'Not enough μDash';
            ...
            if (this.state.engine.gameState === 'IN_PROGRESS') {
                ...
                if (pi && pi.bet && !pi.stopped_at) {
                    ...
                    return D.span(null, 'Cashed Out @  ',
                        ...
                        ' / Won: ',
                        D.b({className: 'green'}, Clib.formatDuffs(pi.bet * pi.stopped_at / 100)),
                ...
                if (pi && pi.stopped_at) { // bet and won
                  ...
                  return D.span(null,
                      'Crashed @ ', D.b({className: 'red'}, this.state.engine.tableHistory[0].game_crash / 100, 'x')
                  );
                }
