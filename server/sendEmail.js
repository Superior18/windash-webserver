...
exports.contact = function(from, content, user, callback) {
    ...
    var details = {
        ...
        from: 'bbitcrash@yandex.com',
        replyTo: from,
        subject: 'windash Contact (' + from + ')',
...
exports.passwordReset = function(to, recoveryList, callback) {
    ...
    var html = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
        ...
        '</head>' +
        '<body>'+
        '<h2>WinDash Password recovery</h2>' +
        '<br>' +
         htmlRecoveryLinks +
        '<br>' +
        '<br>' +
    ...
    var details =  {
        to: to,
        from: 'bbitcrash@yandex.com',
        subject: 'windash.us - Reset Password Request',
        html: html
