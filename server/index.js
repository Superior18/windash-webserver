...
debug('booting WinDash webserver');
...
/**  Server **/
    var options = {
        key: fs.readFileSync('/webserver/key.key'),
        cert: fs.readFileSync('/webserver/cert.crt'),
		ca : fs.readFileSync('/webserver/ca.ca'),
