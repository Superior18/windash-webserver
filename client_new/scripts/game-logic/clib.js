define([
    ...
    function formatDuffs(n, decimals) {
    ...
    return {
        ...
        parseBet: function (betString) {
            ...
            if (bet * 100 > AppConstants.Engine.MAX_BET)
                return new Error('The bet must be less no more than ' + formatDuffs(AppConstants.Engine.MAX_BET) + ' μDash');
        ...
        //Returns plural or singular, for a given amount of μDash.
        grammarBits: function (μDash) {
            return μDash <= 100 ? 'bit' : 'μDash';
        },
