define([
    ...
    function calculatePlayingPercentages(engine) {
        /**
         * bitsPlaying: The total amount of μDash playing(not cashed) minus your qty if you are playing
         * bitsCashedOut: The total amount of μDash cashed before you if you are playing, if you are not its the total cashed out amount minus your qty
