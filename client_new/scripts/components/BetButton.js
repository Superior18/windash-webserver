define([
    ...
    return React.createClass({
        ...
        render: function() {
            ...
            var canUserBet = StateLib.canUserBet(this.props.engine.balanceDuffs, this.props.betSize, this.props.betInvalid, this.props.cashOutInvalid);
            ...
            if(notPlayingOrBetting) {
                ...
                if(isBetting) {
                	...
                	var btnText =   (canUserBet.message === 'Not enough μDash')? (smallButton? 'Bet' : 'Bet too big') : (smallButton? 'Bet' : 'Place bet');
