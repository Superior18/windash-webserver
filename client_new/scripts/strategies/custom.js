...
console.log('The max current bet is: ', engine.getMaxBet()/100, ' μDash');\n\
console.log('The current maxWin is: ', engine.getMaxWin()/100, ' μDash');\n\
...
//engine.placeBet(betInDuffs, autoCashOutinPercent, autoPlay);\n\
\n\
