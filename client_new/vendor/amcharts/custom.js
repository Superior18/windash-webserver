    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>Bet:</th><td>' + (entry.bet/100).toFixed() + ' μDash</td></tr>' +
                ...
                '<tr><th>Bonus: </th><td>' + (entry.bonus ? (entry.bonus/100).toFixed(2) : 0) + ' μDash</td></tr>' +
                "<tr><th>Profit:</th><td><b>" + (profit/100).toFixed(2) + " μDash</b></td></tr>" +
                '</table>';
            return r;
